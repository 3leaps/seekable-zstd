...
- **Release workflow**: Tag-triggered `release.yml` creates GitHub Releases with Go prebuilt bundles.
- **Manual signing**: Make targets and docs for minisign checksums and signature uploads.
- **Quality gates**: goneat assess config with actionlint and checkmake.
